	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Farinneli Store</a>
			</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Carrinho <span class="badge">0</span>	</a>
					...
					<div style="width: 300px;">
						<div class="panel panel-primary">
							...
							<div class="panel-heading">
								...
								<p><br></p>
								<a href="#" style="color: white;list-style-type: none;">Esqueceu a senha?</a>
								<input type="submit" class="btn btn-success" style="float: right;bottom:12px;" id="login" value="Entrar" name="">
							</div>
				...
				<li><a href="customer_registration.php">Cadastrar-se</a></li>
			</ul>
		</div>
	</div>
		<br><br><br>
				...
				<div class="panel panel-info">
					<div class="panel-heading text-center">Produtos
						<div class='pull-right'>
								Filtro: &nbsp;&nbsp;&nbsp;<a href="#" id='price_sort'>Preço</a> | <a href="#" id='pop_sort'>Popularidade</a>
							</div>
					</div>
					...
					<div class="panel-footer">Copyright Farinelli Store &copy; 2021</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
...
<p> Criado por <a href="https://beacons.ai/joaofarinelli">João Farinelli</a></p>
</footer></div>
