		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="panel panel-primary text-center">
					<div class="panel-heading">Checkout Carrinho</div>
					<div class="panel-body"></div>
					<div class="row">
						<div class="col-md-2"><b>Ações</b></div>
						<div class="col-md-2"><b>Imagem do produto</b></div>
						<div class="col-md-2"><b>Nome do produto</b></div>
						<div class="col-md-2"><b>Preço do produto</b></div>
						<div class="col-md-2"><b>Quantidade</b></div>
						<div class="col-md-2"><b>Preço em R$</b></div>
					</div>
					<br><br>
					<div id='cartdetail'>
					<!--<div class="row">
